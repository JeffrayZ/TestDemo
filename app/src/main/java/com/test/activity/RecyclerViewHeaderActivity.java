...
import com.test.IndexBar.widget.IndexBar;
import com.test.R;
import com.test.adapter.CityAdapter;
import com.test.bean.CityBean;
import com.test.decoration.DividerItemDecoration;
import com.test.decoration.TitleItemDecoration;

import java.util.ArrayList;
import java.util.List;

public class RecyclerViewHeaderActivity extends AppCompatActivity {
...
//        mRv.addItemDecoration(new TitleItemDecoration2(this,mDatas));
        mRv.addItemDecoration(new DividerItemDecoration(RecyclerViewHeaderActivity.this, DividerItemDecoration.VERTICAL_LIST));
