package cn.pjcare.www.timepicker.view;
...
import cn.pjcare.www.timepicker.R;
...
public class CustomOptions<T> extends BasePickerView implements View.OnClickListener{
    ...
    public CustomOptions(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.options, contentContainer);
        // -----确定和取消按钮
    ...
    public void setOnoptionsSelectListener(
            CustomOptions.OnOptionsSelectListener optionsSelectListener) {
